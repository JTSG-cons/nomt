...
(function(){
  ...
  var I18N={
    mn:{
      ...
      'loc.fallback.title':'Газрын зураг ачаалагдсангүй','loc.fallback.body':'Сүхбаатар дүүрэг, 10-р хороо — Их Тойруугийн хойд тал, хотын төвөөс ~1.5 км.','loc.fallback.link':'Газрын зураг нээх',
      ...
      'lm.square.d':'~1.5 км · хотын төв','lm.uni.d':'Хөрш зэргэлдээ','lm.gov.d':'Засаг захиргааны цөм','lm.store.d':'Худалдааны төв','lm.mall.d':'Худалдаа, амралт','lm.hosp.d':'Эрүүл мэнд',
    ...
    zh:{
      ...
      'loc.fallback.title':'地图加载失败','loc.fallback.body':'苏赫巴托尔区第10小区——大环路以北，距市中心约1.5公里。','loc.fallback.link':'打开地图',
      'lm.site':'NOMT','lm.square':'成吉思（苏赫巴托尔）广场','lm.uni':'蒙古国立大学','lm.gov':'国家宫 · 使馆区','lm.store':'国营百货','lm.mall':'香格里拉购物中心 / 中央大厦','lm.hosp':'国家第一中心医院',
      'lm.square.d':'~1.5公里 · 市中心','lm.uni.d':'紧邻','lm.gov.d':'行政核心','lm.store.d':'商业中心','lm.mall.d':'购物休闲','lm.hosp.d':'医疗',
    ...
    en:{
      ...
      'loc.fallback.title':'The map could not load','loc.fallback.body':'Sükhbaatar district, Khoroo 10 — north of the Big Ring Road, ~1.5 km from the city centre.','loc.fallback.link':'Open the map',
      ...
      'lm.square.d':'~1.5 km · city centre','lm.uni.d':'Next door','lm.gov.d':'Administrative core','lm.store.d':'Shopping','lm.mall.d':'Retail & leisure','lm.hosp.d':'Healthcare',
